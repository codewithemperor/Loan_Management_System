...
export default function Home() {
  const services = [
    {
      icon: <HandCoins className="h-8 w-8 text-brand-primary" />,
  ...
  const roles = [
    ...
    },
    {
      ...
      color: "bg-brand-secondary/10 text-brand-secondary border-brand-secondary",
      link: "/officer/login"
    },
    {
      title: "Approvers",
      description: "Review and approve loan applications with confidence",
      color: "bg-brand-accent/10 text-brand-accent border-brand-accent",
      link: "/approver/login"
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50/20 to-blue-50/20">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-brand-primary/10 via-transparent to-transparent"></div>
          <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-brand-accent/10 via-transparent to-transparent"></div>
        </div>
        <div className="relative container mx-auto px-4 py-20 md:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex justify-start mb-6">
                <Badge className="bg-brand-primary text-white px-4 py-2 text-sm font-semibold">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button 
                  size="lg" 
                  className="bg-brand-primary hover:bg-brand-primary-dark text-white px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
                  asChild
                >
                ...
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="px-8 py-4 text-lg border-2 border-brand-primary text-brand-primary hover:bg-brand-primary/5 hover:border-brand-primary-dark font-semibold shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-200"
                  asChild
                >
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-brand-primary/20 to-brand-accent/20 rounded-2xl blur-xl"></div>
      ...
      {/* Stats Section */}
      <section className="py-20 bg-gradient-to-r from-brand-primary via-brand-primary-dark to-brand-accent">
        <div className="container mx-auto px-4">
      ...
      {/* Features Section */}
      <section className="py-20 bg-gradient-to-br from-brand-primary/5 via-white to-brand-accent/5">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <div className="text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Button 
                      size="lg" 
                      variant="outline"
                      className="border-2 border-brand-primary text-brand-primary hover:bg-brand-primary/5"
                      asChild
                    >
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <h3 className="text-2xl font-bold text-brand-primary">AOPE Credit</h3>
